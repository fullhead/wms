...
/// Генерирует PDF-документ на основе списка записей отчёта.
/// [title]           - заголовок отчёта (например, "Отчет за день 2025-03-15")
/// [entries]         - список записей отчёта.
/// [responsibleName] - реальное ФИО пользователя
/// [position]        - реальная должность/группа пользователя
        ...
        return [
          ...
          pw.Row(
            ...
            children: [
              ...
              pw.Text(
                // Пара пробелов после слэша для сдвига линии
...
/// Строит таблицу с нумерацией (добавляем столбец "№").
